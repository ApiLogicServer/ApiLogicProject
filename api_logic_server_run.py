...
==============================================================================
    ...
    This file starts the API Logic Server (v 6.00.07, September 12, 2022 15:43:52):
...
if __name__ == "__main__":
    msg = f'API Logic Project Loaded (not WSGI), version 6.00.07, configured for http://{swagger_host}:{port}\n'
    if is_docker():
    ...
    msg = f'API Logic Project Loaded (WSGI), version 6.00.07, configured for {http_type}://{swagger_host}:{port}\n'
    if is_docker():
        msg += f' (running from docker container at {flask_host} - may require refresh)\n'
    app_logger.info(f'\n{msg}')
